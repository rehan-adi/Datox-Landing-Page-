...
function Pricing() {
  return (
    <div className='w-auto h-screen Pricing-img'>
        <div>
             <h1 className='text-4xl pl-20 pt-20 text-white'>Pricing and Features</h1>
        ...
        <div>
              ...
              <div className='w-[440px] text-white relative flex items-center flex-col h-[70vh]  rounded-xl bg-[#1C1C1C]'>
                    <h1 className='text-2xl font-medium pt-6'>BASIC</h1>
                    ...
                    <button className='mt-5 px-16 py-2 rounded-full border-2 '>SELECT</button>
              ...
              <div className='w-[440px] text-white relative flex items-center flex-col h-[70vh]  rounded-xl bg-black'>
                    <h1 className='text-2xl font-medium pt-6'>STANDARD</h1>
                    <h3 className='mt-5 text-5xl'><sup className='text-lg'>$</sup>4.99</h3>
                    <p className='text-xs text-white opacity-90'>Every Month</p>
                    <p className='mt-5 text-sm opacity-80'>Designed for growing businesses</p>
                    <button className='mt-10 px-16 py-2 rounded-full border-2 border-[#5233FF] text-[#5233FF] '>SELECT</button>
                    <div className='w-[440px] flex pl-7 flex-col gap-5 rounded-b-xl bottom-0 absolute text-sm opacity-80 items-start justify-center bg-[#1C1C1C] h-[25vh]'>
              ...
              <div className='w-[440px] text-white relative flex items-center flex-col h-[70vh]  rounded-xl bg-[#1C1C1C]'>
                    <h1 className='text-2xl font-medium pt-6'>PREMIUM</h1>
